...
export default function Home() {
  ...
  return (
    <div
      className={cn(
        "flex flex-col h-screen items-center bg-background/40",
        "sm: justify-center"
      )}
    >
      ...
      <div
        className={cn(
          "flex flex-col w-full h-fit gap-8 px-6 py-8 rounded-t-2xl bg-surface",
          "sm:flex-row sm:max-w-3xl sm:rounded-2xl"
        )}
      >
        {/* Settings */}
        <div
          className={cn(
            "flex flex-col gap-8",
            "sm:justify-between sm:flex-1/2"
          )}
        >
          {/* Bill Amount */}
          <Input
        ...
        <div
          className={cn(
            "flex flex-col flex-grow justify-between gap-8 p-4 rounded-xl bg-primary-darker text-white",
            "sm:flex-1/2"
          )}
        >
          ...
          <button
            ...
            className={cn(
              ...
              "hover:cursor-pointer hover:bg-teal-300",
              "text-primary-accent-text font-bold uppercase"
            )}
          >
            Reset
          </button>
